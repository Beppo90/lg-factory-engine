...
// Uso: node check-content-uniqueness.js DIESEL-2026-04-19-G3
// ============================================================
...
function hashFile(filepath) {
  ...
  const content = fs.readFileSync(filepath, "utf8")
    .replace(/DIESEL-2026-04-19-G\d+/g, "DIESEL-XXXX")
    .replace(/DIESEL-2026-04-19"/g, '"DIESEL-XXXX"');
...
const allRuns = fs.readdirSync(RUNS_BASE)
  .filter(d => d.startsWith("DIESEL-2026-04-19") && d !== targetRun)
  .sort();

...
status: ⚠️ PARADIGM SHIFT PM-3.2 v2.6 → v3.0 · resuelve ANTI-PATRÓN #18 (PM-3.6 saltando PM-3.2 enrichment · ad-hoc dentro output aprendiz · pierde anclaje sistemático PM-0). Solución 2 capas: CAPA 1 PEDAGOGICAL ANCHORING NEW (anclaje §5.x PM-0 per actividad · SIOP · UbD · Krashen · gaps + correcciones · modelo_ejemplo · derivación `*_aprendiz` para PM-3.6) + CAPA 2 PRACTICAL IMPLEMENTATION (legacy v2.6 preservado · Teacher Talk + timeline + checklist · sigue prohibiendo teoría en Teacher Talk). 6 reglas NEW (13-18) + 7 validation checks bloqueantes. Elimina contradicción "cero referencias teóricas" SOLO en CAPA 1 Anchoring · CAPA 2 mantiene canon práctico. PM-3.2 v3.0 ahora es la fuente única de verdad para enrichment pedagógico anclado · PM-3.6 hereda `*_aprendiz` LITERAL desde PM-3.2 (NO genera ad-hoc). Cascade pending v3.16: PM-3.6 v3.6 → v3.7 (consume PM-3.2 v3.0 derivación) + AC v3.4 + Phase 3 dispatch IMARPOR-V2 (PM-3.1 + PM-3.2 ×12 sesiones). ⚠️ APRENDIZ-FACING SHIFT canonization Nivel 2 reducido (preview v6 prólogo cinematográfico aprobado) · AC schema v3.1 → v3.2 + PM-3.6 v3.4 → v3.5 + DM. ⚠️ PM-3.7 DEPRECATED. PARADIGM SHIFT FUNDAMENTAL · NEW PM-0.0 Matriz Pedagógica Alineadora canonizado pre-Fase 1. Sergio Cortés decisión arquitectónica 2026-05-01: el sistema diseñaba "de adentro hacia afuera" en teoría (DM declaraba UbD desde v2.0) pero en práctica reconstruía la matriz GFPI-F-134 retroactivamente en PM-2.11 (al final de Fase 2) usando información agregada que el LLM había procesado sin saber a qué RAP pertenecía cada saber/criterio. v3.0 corrige: PM-0.0 (NEW) toma información curricular SOFÍA agregada (saberes_conceptos + saberes_proceso + criterios_evaluacion + N RAPs · sin pre-clasificar) y ALINEA explícitamente por RAP. Output `pm-0-0-matriz-alineada.json` se vuelve fundamento pedagógico de toda la cadena downstream. PM-0 simplifica de 1077 → ~270 lines operacionales (5 principios maestros · libertad LLM · schema mínimo viable). Cascade impact: PM-0 + PM-1.1 + PM-1.2 + PM-2.0 + PM-2.x + PM-2.11 + PM-3.7 ahora consumen matriz alineada como insumo. PM-3.7 V04 multi-RAP rows se llenan con contenido REAL por RAP (no solo título RAP en R18-R21). DOCX/JSON learner-readable v2.7 (30 Activity Cards anatomy 6-bloque) preservado · NO afectado. **v3.8 canoniza Wave 5.C+5.D (PM-2.11 v3.1+v3.2): agrupación tripartita por RA (gfpi_f134_v04_rows[] de N filas heredadas 1:1 pm-1-2 sub_bloques · NO 1 fila monolítica) + formato canon Sergio C7+C10+C11 (plantillas estructuradas verbatim ejemplos GFPI-F-134 V04 oficial SENA · NO bullets simples ni resúmenes 1-línea ni listas deduplicadas).**
previous_versions:
  - "3.7 (2026-05-02) — Wave 5.C+5.D PM-2.11 v3.1+v3.2 canon · agrupación tripartita 6 filas (B0+B1+B2+B3+B4+BT) + formato canon Sergio C7 actividades V+O+C · C10 evidencias 3 líneas (Evidencia/Técnica/Instrumento No N) · C11 estrategias por actividad · cross-PM downstream PM-3.6/PM-3.7"

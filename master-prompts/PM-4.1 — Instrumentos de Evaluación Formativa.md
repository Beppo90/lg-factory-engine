...
## ESTRUCTURA DE PM-4.1

PM-4.1 contiene DOS instrumentos de evaluación formativa:

| Sección | Instrumento | Evidencia SENA | Uso |
|---------|-------------|----------------|-----|
| **§3** | Checklist de Observación | Desempeño | Durante la simulación oral (Session 6) |
| **§5** | Feedback Loop | Proceso | Después del cuestionario (Session 7) + cierre (Session 8) |
...
- Grammar targets
- Cuestionario PM-4.2 structure (5 sections, 50 pts)

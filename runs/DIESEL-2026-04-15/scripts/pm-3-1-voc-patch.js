...
const PATHS = {
  json_in:  "/sessions/blissful-amazing-lamport/mnt/fpi-sena-factory/runs/DIESEL-2026-04-15/pm-3-1.json",
  json_out1: "/sessions/blissful-amazing-lamport/mnt/fpi-sena-factory/runs/DIESEL-2026-04-15/pm-3-1.json",
  json_out2: "/sessions/blissful-amazing-lamport/mnt/FPI+Research/fpi-sena-factory-vault/runs/DIESEL-2026-04-15/pm-3-1.json",
  docx_out1: "/sessions/blissful-amazing-lamport/mnt/fpi-sena-factory/runs/DIESEL-2026-04-15/pm-3-1-playbook-outline.docx",
  docx_out2: "/sessions/blissful-amazing-lamport/mnt/FPI+Research/fpi-sena-factory-vault/runs/DIESEL-2026-04-15/pm-3-1-playbook-outline.docx",
};
...
async function main() {
  ...
  const children = [
    ...
    spacer(),
    body("Run: DIESEL-2026-04-15  ·  Engine: LG Factory Engine v2.0  ·  Rev: 2026-04-18 (+ V+O+C Dimensions)"),
  ...
  const doc = new Document({
    sections: [{
      ...
      headers: {
        default: new Header({
          children: [new Paragraph({
            children: [new TextRun({ text: "PM-3.1 Playbook Outline  |  The Workshop Specialist  |  DIESEL-2026-04-15", size: pt(9), font: "Calibri", color: "888888" })],

 ...
 *   1. pm-3-2-s1-review.docx  (S1 piloto MGV G1)
 *   2. pm-4-1-review.docx     (5 instrumentos formativos)
 *   3. pm-4-2-review.docx     (Cuestionario Consolidado E6)
 *
 * Output path: /sessions/focused-cool-dirac/mnt/fpi-sena-factory/runs/MGV-2026-04-20/
 */
...
function buildPM41Doc() {
  ...
  // Canon
  children.push(H1('2. Canon de puntuación MGV G1'));
...
function buildPM42Doc() {
  ...
  return new Document({
    creator: 'FPI CD Engine v2.5.1',
    title: 'PM-4.2 Cuestionario E6 Review · MGV G1',
    styles: { default: { document: { run: { font: 'Calibri', size: 20 } } } },
    sections: [{
      properties: {
        page: {

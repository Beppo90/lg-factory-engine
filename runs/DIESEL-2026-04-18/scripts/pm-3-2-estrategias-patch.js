...
const fs = require("fs");
const BASE = "/sessions/blissful-amazing-lamport/mnt/fpi-sena-factory/runs/DIESEL-2026-04-18";
const VAULT = "/sessions/blissful-amazing-lamport/mnt/FPI+Research/fpi-sena-factory-vault/runs/DIESEL-2026-04-18";
...
const OUT_ANCHOR = `const OUT  = "/sessions/blissful-amazing-lamport/mnt/FPI+Research/fpi-sena-factory-vault/runs/DIESEL-2026-04-18/pm-3-2-build-out-completo.docx";`;
const OUT_REPLACE = `const OUT  = "/sessions/blissful-amazing-lamport/mnt/FPI+Research/fpi-sena-factory-vault/runs/DIESEL-2026-04-18/pm-3-2-build-out-completo.docx";
const OUT2 = "/sessions/blissful-amazing-lamport/mnt/fpi-sena-factory/runs/DIESEL-2026-04-18/pm-3-2-build-out-completo.docx";`;

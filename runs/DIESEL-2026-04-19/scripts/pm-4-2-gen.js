...
const DATA = JSON.parse(fs.readFileSync(
  "/sessions/blissful-amazing-lamport/mnt/fpi-sena-factory/runs/DIESEL-2026-04-19/pm-4-2.json", "utf8"
));
...
function coverPage() {
  ...
  return [
    ...
    new Paragraph({
      children: [new TextRun({ text: "Mantenimiento de los Motores Diesel — Técnico", size: pt(10), font: "Calibri", color: DGRAY })],
...
async function main() {
  ...
  const OUT1 = "/sessions/blissful-amazing-lamport/mnt/fpi-sena-factory/runs/DIESEL-2026-04-19/pm-4-2-cuestionario.docx";
  const OUT2 = "/sessions/blissful-amazing-lamport/mnt/FPI+Research/fpi-sena-factory-vault/runs/DIESEL-2026-04-19/pm-4-2-cuestionario.docx";

...
function makeCoverPage() {
  return [
    ...
    new Paragraph({
      children: [new TextRun({ text: "Run ID: DIESEL-2026-04-19", font: "Calibri", size: 22, color: "777777" })],
      alignment: AlignmentType.CENTER,
      spacing: { before: 0, after: 160 },
    }),
    new Paragraph({
...
const OUT  = "/sessions/blissful-amazing-lamport/mnt/FPI+Research/fpi-sena-factory-vault/runs/DIESEL-2026-04-19/pm-3-2-build-out-completo.docx";

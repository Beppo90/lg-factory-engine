...
const JSON_PATH  = "/sessions/blissful-amazing-lamport/mnt/fpi-sena-factory/runs/DIESEL-2026-04-15/pm-3-1.json";
const JSON_VAULT = "/sessions/blissful-amazing-lamport/mnt/FPI+Research/fpi-sena-factory-vault/runs/DIESEL-2026-04-15/pm-3-1.json";
const DOCX_PATH  = "/sessions/blissful-amazing-lamport/mnt/fpi-sena-factory/runs/DIESEL-2026-04-15/pm-3-1-playbook-outline.docx";
const DOCX_VAULT = "/sessions/blissful-amazing-lamport/mnt/FPI+Research/fpi-sena-factory-vault/runs/DIESEL-2026-04-15/pm-3-1-playbook-outline.docx";
...
async function main() {
  const children = [
    ...
    spacer(),
    body("Run: DIESEL-2026-04-15  ·  Rev: 2026-04-18 (v1.2 — Ambientes + Materiales + V+O+C)"),
    ...
    body("PM-3.1 v1.2  |  DIESEL-2026-04-15  |  LG Factory Engine v2.0  |  Instructor only"),
  ];

  const doc = new Document({
    sections: [{
      properties: { page: { size: { width: 12240, height: 15840 }, margin: { top: 1080, bottom: 1080, left: 1080, right: 1080 } } },
      headers: { default: new Header({ children: [new Paragraph({ children: [new TextRun({ text: "PM-3.1 Playbook Outline  |  The Workshop Specialist  |  DIESEL-2026-04-15  |  INSTRUCTOR ONLY", size: pt(9), font: "Calibri", color: "888888" })], alignment: AlignmentType.RIGHT, border: { bottom: { style: BorderStyle.SINGLE, size: 4, color: MGRAY } } })] }) },

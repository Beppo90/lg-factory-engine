...
const DATA = JSON.parse(fs.readFileSync(
  "/sessions/blissful-amazing-lamport/mnt/fpi-sena-factory/runs/DIESEL-2026-04-15/pm-4-1.json", "utf8"
));
...
function coverPage() {
  ...
  return [
    ...
    new Paragraph({
      children: [new TextRun({ text: `Run: DIESEL-2026-04-15  ·  LG Factory Engine v2.0`, size: pt(9), font: "Calibri", color: DGRAY })],
      alignment: AlignmentType.CENTER,
    }),
    pageBreak(),
  ];
...
async function main() {
  ...
  const OUT1 = "/sessions/blissful-amazing-lamport/mnt/fpi-sena-factory/runs/DIESEL-2026-04-15/pm-4-1-instrumentos.docx";
  const OUT2 = "/sessions/blissful-amazing-lamport/mnt/FPI+Research/fpi-sena-factory-vault/runs/DIESEL-2026-04-15/pm-4-1-instrumentos.docx";

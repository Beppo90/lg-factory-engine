...
function sec7() {
  ...
  out.push(simpleTable(
    ...
    [
      ["1.0", "2026-04-15", "LG Factory Engine v2.0 / DIESEL-2026-04-18", "Versión inicial — estructura completa 8 sesiones, 28 actividades, 7 evidencias."],
...
async function main() {
  ...
  const OUT1 = "/sessions/blissful-amazing-lamport/mnt/fpi-sena-factory/runs/DIESEL-2026-04-18/pm-3-6-learning-guide.docx";
  const OUT2 = "/sessions/blissful-amazing-lamport/mnt/FPI+Research/fpi-sena-factory-vault/runs/DIESEL-2026-04-18/pm-3-6-learning-guide.docx";

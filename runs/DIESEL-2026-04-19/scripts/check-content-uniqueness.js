...
//
// Uso: node check-content-uniqueness.js DIESEL-2026-04-19-G2
//       (asume que DIESEL-2026-04-19-G1 ya existe — compara contra G1)
//
...
if (!targetRun) {
  ...
  console.error("Example: node check-content-uniqueness.js DIESEL-2026-04-19-G2");
  process.exit(1);
}
